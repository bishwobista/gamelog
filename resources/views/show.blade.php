    ...
    <div class="container mx-auto px-4">
        ...
        <div class="images-container border-b border-gray-800 pb-12 mt-8">
            ...
            <div class="grid gird-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
                <div>
                    <a href="#">
                        <img src="https://picsum.photos/200/300" alt="screenshot" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
            ...
            <div class="similar-games text-sm grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 xl:grid-cols-6 gap-12">
                <div class="game mt-8">
                    <div class="relative inline-block">
                        <a href="#">
                            <img src="https://picsum.photos/200/300" alt="game cover" class="hover:opacity-75 transition ease-in-out duration-150">
                        </a>
